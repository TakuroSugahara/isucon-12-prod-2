...
sudo cat $NGINX_LOG | alp json --sort sum -r -o "count,1xx,2xx,3xx,4xx,5xx,method,uri,min,max,sum,avg,min_body,max_body,avg_body" -m "/user/[0-9a-zA-Z]+/present/index/[0-9a-zA-Z]+,/user/[0-9a-zA-Z]+/present/receive,/user/[0-9a-zA-Z]+/gacha/draw/[0-9a-zA-Z]+,/user/[0-9a-zA-Z]+/home,/user/[0-9a-zA-Z]+/reward,/user/[0-9a-zA-Z]+/item,/user/[0-9a-zA-Z]+/card,/user/[0-9a-zA-Z]+/gacha/index,/admin/user/[0-9a-zA-Z]+" > $NGINX_TMP_LOG
